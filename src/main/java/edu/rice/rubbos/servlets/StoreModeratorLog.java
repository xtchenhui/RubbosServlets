      ...
      throws IOException, ServletException
  {
    ...
    if ((nickname != null) && (password != null))
    {
      try
      {
        ...
        buddy.println(start+" "+end+" StoreComment");
      }
      catch (Exception e)
      {
    ...
    else
    {
      ...
      long start = System.currentTimeMillis();
        ...
        rs = stmt.executeQuery();
      long end = System.currentTimeMillis();
      buddy.println(start+" "+end+" "+" storeModeratorlog");
        if (!rs.first())
        {
          sp
        ...
        else
        {
          ...
          if (rating != 0)
          {
            ...
            long endupdate = System.currentTimeMillis();
             buddy.println(startupdate+" "+endupdate+" "+" updaterating");
            ...
            long end1 = System.currentTimeMillis();
             buddy.println(end+" "+end1+" "+" updaterating");
        ...
        buddy.println(start2+" "+end2+" "+" updaterating");
        ...
        buddy.println(start3+" "+end3+" "+" updaterating");
       ...
       long end4 = System.currentTimeMillis();
        buddy.println(start4+" "+end4+" "+" updaterating");
