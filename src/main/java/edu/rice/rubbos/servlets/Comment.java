...
class Comment
{
  ...
  public static void displayFilterChooser(Connection conn, ServletPrinter sp,
      ...
      int filter,PrintStream buddy) throws Exception
  {
    int i, count, rating;
    ...
    buddy.println(start+" "+end+" "+" Comment");
  ...
  private static void fetchLowerLevels(HashMap map, int level, Connection conn,
      int filter, int commentId, String commentTable, String storyId, int cid, int display,PrintStream buddy)
      throws SQLException
  {
    ResultSet         follow;
    ...
    */
    ...
    long end=System.currentTimeMillis();
    buddy.println(start+" "+end+" "+" lowComment");
    ...
    if (deeper)
    {
      fetchLowerLevels(map, level+1, conn, filter, commentId, commentTable, storyId, cid, display,buddy);
    }

  }

  private static HashMap fetchComments(Connection conn, int filter,
      int commentId, String commentTable, String storyId, int parent, int display,PrintStream buddy)
  throws SQLException
  {
    ...
    rs = stmt.executeQuery();
    long end=System.currentTimeMillis();
    buddy.println(start+" "+end+" "+" fetchComment");
  ...
  public static void fetchAndDisplay(ServletPrinter sp, Connection conn,
      ...
      String storyId, int parent, PrintStream buddy) throws Exception
  {
